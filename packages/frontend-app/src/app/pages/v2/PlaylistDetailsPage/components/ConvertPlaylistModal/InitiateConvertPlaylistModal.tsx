...
import {
  CONVERT_PLAYLIST_MODAL_LOCAL_STORAGE_KEY,
  parseInitiateConvertPlaylist,
} from "./utils";
...
import type { InitiateConvertPlaylist } from "./utils";
...
export const InitiateConvertPlaylistModal: React.FC<IProps> = ({
  open,
  onClose,
}) => {
  ...
  const handleSubmitFormValues = (values: InitiateConvertPlaylist) => {
  ...
  return (
    <Modal open={open} onClose={handleClose} title="Port this playlist">
      <Form
        ...
        validate={parseInitiateConvertPlaylist}
